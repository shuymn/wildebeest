...
import { LocalPreference, getHomeTimeline, getPublicTimeline } from 'wildebeest/backend/src/mastodon/timeline'
...
describe('mastodon/timeline', () => {
	...
	test("home doesn't show private Notes from followed actors", async () => {
		...
		const data = await getHomeTimeline(domain, db, actor3)
