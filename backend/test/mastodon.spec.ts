...
import * as blocks from 'wildebeest/routes/api/v1/blocks'
import * as custom_emojis from 'wildebeest/routes/api/v1/custom_emojis'
import * as v1_instance from 'wildebeest/routes/api/v1/instance'
import * as mutes from 'wildebeest/routes/api/v1/mutes'
import * as v2_instance from 'wildebeest/routes/api/v2/instance'
