...
import * as accounts_get from 'wildebeest/routes/api/v1/accounts/[id]'
import * as accounts_featured_tags from 'wildebeest/routes/api/v1/accounts/[id]/featured_tags'
import * as accounts_follow from 'wildebeest/routes/api/v1/accounts/[id]/follow'
import * as accounts_followers from 'wildebeest/routes/api/v1/accounts/[id]/followers'
import * as accounts_following from 'wildebeest/routes/api/v1/accounts/[id]/following'
import * as accounts_lists from 'wildebeest/routes/api/v1/accounts/[id]/lists'
import * as accounts_statuses from 'wildebeest/routes/api/v1/accounts/[id]/statuses'
import * as accounts_unfollow from 'wildebeest/routes/api/v1/accounts/[id]/unfollow'
import * as lookup from 'wildebeest/routes/api/v1/accounts/lookup'
import * as accounts_relationships from 'wildebeest/routes/api/v1/accounts/relationships'
import * as accounts_update_creds from 'wildebeest/routes/api/v1/accounts/update_credentials'
import * as accounts_verify_creds from 'wildebeest/routes/api/v1/accounts/verify_credentials'
import * as filters from 'wildebeest/routes/api/v1/filters'
import * as preferences from 'wildebeest/routes/api/v1/preferences'
