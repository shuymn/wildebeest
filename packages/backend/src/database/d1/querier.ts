...
export async function selectNotificationsByActorId(
	...
	return await d1
		...
		.then((r: D1Result<RawSelectNotificationsByActorIdRow>) => {
			return {
				...r,
				results: r.results.map((raw: RawSelectNotificationsByActorIdRow) => {
					return {
						id: raw.id,
						type: raw.type,
...
export async function selectNotificationsByIdAndActorId(
	...
	return await d1
		...
		.then((raw: RawSelectNotificationsByIdAndActorIdRow | null) =>
			raw
				? {
						id: raw.id,
						type: raw.type,
...
export async function insertActorPreferences(d1: D1Database, args: InsertActorPreferencesParams): Promise<D1Result> {
...
export async function insertActor(d1: D1Database, args: InsertActorParams): Promise<D1Result> {
	return await d1
...
export async function updateActorAlias(d1: D1Database, args: UpdateActorAliasParams): Promise<D1Result> {
	return await d1.prepare(updateActorAliasQuery).bind(args.alias, args.id).run()
}
...
export async function updateActorMastodonIdByMastodonId(
	...
	return await d1.prepare(updateActorMastodonIdByMastodonIdQuery).bind(args.next, args.current).run()
}
...
export async function updateActorProperties(d1: D1Database, args: UpdateActorPropertiesParams): Promise<D1Result> {
	return await d1.prepare(updateActorPropertiesQuery).bind(args.properties, args.id).run()
}
...
export async function selectActor(d1: D1Database, args: SelectActorParams): Promise<SelectActorRow | null> {
	return await d1
		.prepare(selectActorQuery)
		.bind(args.id)
		.first<RawSelectActorRow | null>()
		.then((raw: RawSelectActorRow | null) =>
			raw
				? {
						id: raw.id,
						mastodonId: raw.mastodon_id,
...
export async function selectActorByMastodonId(
	...
	return await d1
		...
		.then((raw: RawSelectActorByMastodonIdRow | null) =>
			raw
				? {
						id: raw.id,
						mastodonId: raw.mastodon_id,
...
export async function selectActorByUsernameAndDomain(
	...
	return await d1
		...
		.then((raw: RawSelectActorByUsernameAndDomainRow | null) =>
			raw
				? {
						id: raw.id,
						mastodonId: raw.mastodon_id,
...
export async function deleteActor(d1: D1Database, args: DeleteActorParams): Promise<D1Result> {
	return await d1.prepare(deleteActorQuery).bind(args.id).run()
}
...
export async function insertIdSequence(
	...
	return await d1.prepare(insertIdSequenceQuery).bind(args.key).first<InsertIdSequenceRow | null>()
}
...
export async function insertObjectRevision(d1: D1Database, args: InsertObjectRevisionParams): Promise<D1Result> {
	return await d1.prepare(insertObjectRevisionQuery).bind(args.objectId, args.properties).run()
}
...
export async function insertRemoteObject(d1: D1Database, args: InsertRemoteObjectParams): Promise<D1Result> {
	return await d1
		...
		.bind(
			...
			args.type,
			args.cdate,
			args.originalActorId,
			args.originalObjectId,
			args.replyToObjectId,
			args.properties
		)
		.run()
}
...
export async function insertLocalObject(d1: D1Database, args: InsertLocalObjectParams): Promise<D1Result> {
	return await d1
...
export async function updateObjectMastodonIdByMastodonId(
	...
	return await d1.prepare(updateObjectMastodonIdByMastodonIdQuery).bind(args.next, args.current).run()
}
...
export async function selectObject(d1: D1Database, args: SelectObjectParams): Promise<SelectObjectRow | null> {
	return await d1
		.prepare(selectObjectQuery)
		.bind(args.id)
		.first<RawSelectObjectRow | null>()
		.then((raw: RawSelectObjectRow | null) =>
			raw
				? {
						id: raw.id,
						mastodonId: raw.mastodon_id,
...
export async function selectObjectByOriginalObjectId(
	...
	return await d1
		...
		.then((raw: RawSelectObjectByOriginalObjectIdRow | null) =>
			raw
				? {
						id: raw.id,
						mastodonId: raw.mastodon_id,
...
export async function selectObjectByMastodonId(
	...
	return await d1
		...
		.then((raw: RawSelectObjectByMastodonIdRow | null) =>
			raw
				? {
						id: raw.id,
						mastodonId: raw.mastodon_id,
...
export async function updateObjectProperties(d1: D1Database, args: UpdateObjectPropertiesParams): Promise<D1Result> {
	return await d1.prepare(updateObjectPropertiesQuery).bind(args.properties, args.id).run()
}
...
export async function selectAllPeerDomains(d1: D1Database): Promise<D1Result<SelectAllPeerDomainsRow>> {
	return await d1.prepare(selectAllPeerDomainsQuery).all<SelectAllPeerDomainsRow>()
}
...
export async function insertPeer(d1: D1Database, args: InsertPeerParams): Promise<D1Result> {
	return await d1.prepare(insertPeerQuery).bind(args.domain).run()
}
...
export async function insertUser(d1: D1Database, args: InsertUserParams): Promise<D1Result> {
	return await d1
...
export async function selectUserByEmail(
	...
	return await d1
		...
		.then((raw: RawSelectUserByEmailRow | null) =>
			raw
				? {
						id: raw.id,
						mastodonId: raw.mastodon_id,
...
export async function selectAdminByEmail(
	...
	return await d1
		...
		.then((raw: RawSelectAdminByEmailRow | null) =>
			raw
				? {
						id: raw.id,
						mastodonId: raw.mastodon_id,
